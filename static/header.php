<nav class="primary-nav">
	<ul>
		...
		<li>
			<a href="airstream_photobooth.php">Airstream Photo Booth</a>
			<ul>
				...
				<li><a href="photobooth_themes.php">Custom themes</a></li>
			</ul>
		</li>
		<li>
...
<div class="logo">
	<a href="index.php">
		<img src="imgs/logo/left wing.svg" class="svg wing">
		<h1 class="brand-logo">Airstream Studio</h1>
		<img src="imgs/logo/right wing.svg" class="svg wing">
	</a>
</div>
