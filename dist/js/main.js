...
var _extends = Object.assign || function (a) {
  for (var b = 1; b < arguments.length; b++) {
    var c = arguments[b];for (var d in c) Object.prototype.hasOwnProperty.call(c, d) && (a[d] = c[d]);
  }return a;
},
  ...
  var a = { elements_selector: "img", container: window, threshold: 300, throttle: 150, data_src: "original", data_srcset: "originalSet", class_loading: "loading", class_loaded: "loaded", class_error: "error", class_initial: "initial", skip_invisible: !0, callback_load: null, callback_error: null, callback_set: null, callback_processed: null },
    ...
    this._settings = _extends({}, a, b), this._queryOriginNode = this._settings.container === window ? document : this._settings.container, this._previousLoopTime = 0, this._loopTimeout = null, this._boundHandleScroll = this.handleScroll.bind(this), this._isFirstLoop = !0, window.addEventListener("resize", this._boundHandleScroll), this.update();
      ...
      }for (; g.length;) d.splice(g.pop(), 1), c(a.callback_processed, d.length);0 === e && this._stopScrollHandler(), h && (this._isFirstLoop = !1);
    ...
    var c = b.length;if (c) for (var d = 0; d < c; d++) k(a, b[d]);else k(a, b);
  }(n, o), n;
});
  ...
  render(urls, cb) {
    ...
    return _asyncToGenerator(function* () {
      ...
      for (let i = 0; i < reviewCountHalf; i++) {
        _this.elContainer.firstChild.insertAdjacentHTML('beforeEnd', _this.reviewTemplate(urls[i]));
      }

      // append half of the reviews to the second column
      for (let i = reviewCountHalf; i < reviewCount; i++) {
        _this.elContainer.lastChild.insertAdjacentHTML('beforeEnd', _this.reviewTemplate(urls[i]));
      }

      // embed social plugins and run callback when done
      FB.XFBML.parse(_this.elContainer, cb);
    })();
  }
...
},{"./Fetch.js":11,"./facebookAPI.js":14,"AOS":1}],10:[function(require,module,exports){
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
class FacebookStars {
  ...
  getRating() {
    return _asyncToGenerator(function* () {
      const rating = yield Fetch.get(`${BASE_URL}/${PAGE_ID}?access_token=${ACCESS_TOKEN}&fields=overall_star_rating`);
...
},{"./Fetch.js":11,"./facebookAPI.js":14}],11:[function(require,module,exports){
function _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step("next", value); }, function (err) { step("throw", err); }); } } return step("next"); }); }; }
...
class ImageSlider {
  ...
  animate(start, end) {
    ...
    return _asyncToGenerator(function* () {
      ...
      const delta = Math.floor(distance / _this.frames);
      const ticker = Math.floor(_this.time / _this.frames);
      let currentFrame = 0;

      console.log(_this.elSlider.scrollLeft + distance);

      let myTimer = setInterval(function () {
        //make sure the end of the animation has not been reached
        if (currentFrame < _this.frames) {
          _this.elSlider.scrollLeft += delta;
        } else {
          // the end of the animation has been reached so stop the interval
          console.log(_this.elSlider.scrollLeft);
...
},{"scroll":5,"vanilla-lazyload":6}],13:[function(require,module,exports){
class Nav {
  constructor() {
...
document.addEventListener('DOMContentLoaded', _asyncToGenerator(function* () {
  ...
  if (document.body.classList.contains('home')) {
    ...
    if (cache) {
      ...
      var [rating, ratings, ratingsOpenGraph] = yield Promise.all([FacebookStars.getRating(), FacebookReviews.getRatings(), FacebookReviews.getRatingsOpenGraph()]);
...
},{"./CopyLink.js":7,"./CrossFader.js":8,"./FacebookAPI.js":14,"./FacebookReviews.js":9,"./FacebookStars.js":10,"./ImageSlider.js":12,"./Nav.js":13,"aos":1,"lscache":3}]},{},[15]);
