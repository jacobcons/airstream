...
},{"core-js/fn/regexp/escape":3,"core-js/shim":328,"regenerator-runtime/runtime":333}],3:[function(require,module,exports){
'use strict';
...
},{"global":329}],333:[function(require,module,exports){
(function (global){
"use strict";
...
function scroll(prop, element, to, options, callback) {
  ...
  if (from === to) {
    return callback(new Error('Element already at target scroll position'), element[prop]);
  }
...
module.exports = {
  top: function top(element, to, options, callback) {
    return scroll('scrollTop', element, to, options, callback);
  },
  left: function left(element, to, options, callback) {
    return scroll('scrollLeft', element, to, options, callback);
  }
};

},{"rafl":332}],335:[function(require,module,exports){
"use strict";
...
var _extends = Object.assign || function (a) {
  ...
  "use strict";
  var a = { elements_selector: "img", container: window, threshold: 300, throttle: 150, data_src: "original", data_srcset: "originalSet", class_loading: "loading", class_loaded: "loaded", class_error: "error", class_initial: "initial", skip_invisible: !0, callback_load: null, callback_error: null, callback_set: null, callback_processed: null },
    ...
    this._settings = _extends({}, a, b), this._queryOriginNode = this._settings.container === window ? document : this._settings.container, this._previousLoopTime = 0, this._loopTimeout = null, this._boundHandleScroll = this.handleScroll.bind(this), this._isFirstLoop = !0, window.addEventListener("resize", this._boundHandleScroll), this.update();
      ...
      var a = this._settings.throttle;if (0 !== a) {
        var b = Date.now(),
            c = a - (b - this._previousLoopTime);c <= 0 || c > a ? (this._loopTimeout && (clearTimeout(this._loopTimeout), this._loopTimeout = null), this._previousLoopTime = b, this._loopThroughElements()) : this._loopTimeout || (this._loopTimeout = setTimeout(function () {
...
var CopyLink = function () {
  ...
  _createClass(CopyLink, [{
    key: 'init',
    value: function init() {
      this.elLinks.forEach(function (link) {
  ...
  _createClass(CrossFader, [{
    ...
    value: function init() {
      ...
      setInterval(function () {
        return _this.elContainer.lastChild.style.opacity = 0;
      }, 4000);

      // event listener for when image fades out
      this.elImages.forEach(function (image) {
        image.addEventListener('transitionend', function () {
          // insert image that just faded out to the bottom
          _this.elContainer.insertBefore(image, _this.elContainer.firstChild);
...
var _require = require('./facebookAPI.js'),
...
var FacebookReviews = function () {
  function FacebookReviews(reviewCount) {
    _classCallCheck(this, FacebookReviews);
  ...
  _createClass(FacebookReviews, [{
    key: 'render',
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(urls, cb) {
        var reviewCount, reviewCountHalf, i, _i;

        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                reviewCount = urls.length;
                reviewCountHalf = Math.floor(reviewCount / 2);

                // append half of the reviews to the first column

                for (i = 0; i < reviewCountHalf; i++) {
                ...
                for (_i = reviewCountHalf; _i < reviewCount; _i++) {
                  this.elContainer.lastChild.insertAdjacentHTML('beforeEnd', this.reviewTemplate(urls[_i]));
                }
    ...
    key: 'reviewTemplate',
    value: function reviewTemplate(url) {
    ...
    key: 'buildUrls',
    value: function buildUrls(ratings, ratingsOpenGraph) {
      var reviews = [];
      for (var i = 0; i < ratings.length; i++) {
        if (ratingsOpenGraph[i].open_graph_story.data.review_text) {
          var userId = ratings[i].reviewer.id;
          var postId = ratingsOpenGraph[i].open_graph_story.id;
    ...
    key: 'getRatingsOpenGraph',
    value: function getRatingsOpenGraph() {
...
},{"./Fetch.js":341,"./facebookAPI.js":344,"AOS":1}],340:[function(require,module,exports){
'use strict';
...
var FacebookStars = function () {
  function FacebookStars() {
    _classCallCheck(this, FacebookStars);
  }

  _createClass(FacebookStars, [{
    key: 'render',
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Fetch.get(BASE_URL + '/' + PAGE_ID + '?access_token=' + ACCESS_TOKEN + '&fields=overall_star_rating');

              case 2:
                rating = _context2.sent;
                return _context2.abrupt('return', rating.overall_star_rating / 5 * 100 + '%');
  ...
  return FacebookStars;
}();

module.exports = new FacebookStars();

},{"./Fetch.js":341,"./facebookAPI.js":344}],341:[function(require,module,exports){
"use strict";
...
var ImageSlider = function () {
  function ImageSlider() {
    var frames = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 60;
  ...
  _createClass(ImageSlider, [{
    ...
    value: function init() {
      ...
      this.elLeftControl.addEventListener('click', function () {
        // if slider isn't at beginning
        if (_this.elSlider.scrollLeft != 0) {
          // calculate image number of previous image
          var prevImage = _this.prevImageNumber(_this.imageNumber);

          // set scroll left of the slider to center new image
          scroll.left(_this.elSlider, _this.calcScrollLeft(prevImage));
        }
      });

      this.elRightControl.addEventListener('click', function () {
        // if slider hasn't reached end
        if (_this.elSlider.scrollLeft != _this.elSlider.scrollWidth - _this.elSlider.offsetWidth) {
          // calculate image number of next image
          var nextImage = _this.nextImageNumber(_this.imageNumber);

          // set scroll left of the slider to center new image
          scroll.left(_this.elSlider, _this.calcScrollLeft(nextImage));
        }
      });
    }
  }, {
    key: 'prevImageNumber',
    value: function prevImageNumber(imageNumber) {
      return imageNumber % 1 == 0 ? imageNumber - 1 : Math.floor(imageNumber);
    }
  }, {
    key: 'nextImageNumber',
    value: function nextImageNumber(imageNumber) {
      return imageNumber % 1 == 0 ? imageNumber + 1 : Math.ceil(imageNumber);
    }
  }, {
    key: 'calcScrollLeft',
    value: function calcScrollLeft(imageNumber) {
    ...
    value: function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(start, end) {
        ...
        var distance, delta, ticker, currentFrame, myTimer;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                distance = end - start;
                delta = Math.floor(distance / this.frames);
                ticker = Math.floor(this.time / this.frames);
                currentFrame = 0;
                ...
                myTimer = setInterval(function () {
                  ...
                  if (currentFrame < _this2.frames) {
                    _this2.elSlider.scrollLeft += delta;
                  } else {
                    // the end of the animation has been reached so stop the interval
                    console.log(_this2.elSlider.scrollLeft);
    ...
    key: 'imageNumber',
    get: function get() {
      var imageNumber = (this.elSlider.scrollLeft + this.centerAdjust) / this.elImage.offsetWidth;
...
},{"scroll":334,"vanilla-lazyload":335}],343:[function(require,module,exports){
'use strict';
...
var Nav = function () {
  ...
  _createClass(Nav, [{
    ...
    value: function toggleHamburgerMenu() {
      ...
      this.elHamburgerMenu.addEventListener('click', function () {
        _this.elHamburgerMenu.classList.toggle('hamburger-menu--is-active');
      });
    }
  }, {
    key: 'toggleSubNav',
    value: function toggleSubNav() {
      ...
      this.hasSubItem.forEach(function (item) {
...
document.addEventListener('DOMContentLoaded', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var CopyLink, ImageSlider, CrossFader, FacebookAPI, FacebookStars, FacebookReviews, cache, urls, rating, _ref2, _ref3, ratings, ratingsOpenGraph;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          FacebookAPI = require('./FacebookAPI.js');
          FacebookStars = require('./FacebookStars.js');
          FacebookReviews = require('./FacebookReviews.js');
          cache = lscache.get('facebook');
          ...
          urls = cache.urls, rating = cache.rating;
        ...
        case 17:
          _context.next = 19;
          return Promise.all([FacebookStars.getRating(), FacebookReviews.getRatings(), FacebookReviews.getRatingsOpenGraph()]);
        ...
        case 19:
          ...
          rating = _ref3[0];
          ratings = _ref3[1];
          ratingsOpenGraph = _ref3[2];
          urls = FacebookReviews.buildUrls(ratings.data, ratingsOpenGraph.data);
        ...
        case 27:
          ...
          FacebookReviews.render(urls, function () {
...
},{"./CopyLink.js":337,"./CrossFader.js":338,"./FacebookAPI.js":344,"./FacebookReviews.js":339,"./FacebookStars.js":340,"./ImageSlider.js":342,"./Nav.js":343,"aos":1,"babel-polyfill":2,"lscache":330,"nodelist-foreach-polyfill":331,"whatwg-fetch":336}]},{},[345]);
